...
SOURCES = \
	__init__.py \
	lidar_downloader.py lidar_downloader_dialog.py

PLUGINNAME = lidar_downloader

PY_FILES = \
	__init__.py \
	lidar_downloader.py lidar_downloader_dialog.py

UI_FILES = lidar_downloader_dialog_base.ui
...
QGISDIR=C:\Users\Mt\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
