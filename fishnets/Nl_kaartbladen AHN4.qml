...
<qgis maxScale="0" simplifyAlgorithm="0" minScale="100000000" simplifyDrawingTol="1" version="3.22.2-Białowieża" readOnly="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" labelsEnabled="1" simplifyLocal="1">
  ...
  <temporal enabled="0" durationField="" startField="" startExpression="" durationUnit="min" mode="0" accumulate="0" endField="" limitMode="0" endExpression="" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fieldName="Name" multilineHeight="1" blendMode="0" legendString="Aa" fontWeight="50" fontUnderline="0" fontSize="10" useSubstitutions="0" previewBkgrdColor="255,255,255,255" isExpression="0" namedStyle="Regular" fontWordSpacing="0" allowHtml="0" textOpacity="1" fontKerning="1" textOrientation="horizontal" fontFamily="MS Shell Dlg 2" fontLetterSpacing="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" textColor="255,170,0,255" fontStrikeout="0" fontItalic="0">
        <families/>
  ...
  <aliases>
    ...
    <alias name="" field="AHN4_DTM_05m" index="2"/>
    <alias name="" field="AHN4_DTM_5m" index="3"/>
    <alias name="" field="AHN4_DSM_05m" index="4"/>
    <alias name="" field="AHN4_DSM_5m" index="5"/>
    <alias name="" field="AHN4_LAZ" index="6"/>
    <alias name="" field="Shape__Area" index="7"/>
    <alias name="" field="Shape__Length" index="8"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="AHN4_DTM_05m"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="AHN4_DTM_5m"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="AHN4_DSM_05m"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="AHN4_DSM_5m"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="AHN4_LAZ"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="Shape__Area"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0" field="Shape__Length"/>
  </constraints>
