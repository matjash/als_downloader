...
from .agis_about_dialog import ArheoloskiGisAboutDialog
import os.path
...
class ArheoloskiGisAbout:
    ...
    def __init__(self, iface):
        ...
        self.dlg = ArheoloskiGisAboutDialog()
  

        self.dlg = ArheoloskiGisAboutDialog()
        logo_path = path('icons')/"CPA_logo_small.png"
        self.dlg.cpa_logo.setPixmap(QPixmap(str(logo_path)))
